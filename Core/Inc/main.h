...
#define IV_SPL_Pin GPIO_PIN_13
#define IV_SPL_GPIO_Port GPIOB
#define IV_SFD_Pin GPIO_PIN_15
#define IV_SFD_GPIO_Port GPIOB
#define FIR_SB_ME_Pin GPIO_PIN_11
#define FIR_SB_ME_GPIO_Port GPIOD
#define IV_STD_Pin GPIO_PIN_6
#define IV_STD_GPIO_Port GPIOC
#define IV_STE_Pin GPIO_PIN_8
#define IV_STE_GPIO_Port GPIOB
#define IV_SFE_Pin GPIO_PIN_9
#define IV_SFE_GPIO_Port GPIOB
